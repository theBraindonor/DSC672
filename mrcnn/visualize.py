...
# Used this code from issue #38 https://github.com/matterport/Mask_RCNN/pull/38
def save_image(image, image_name, boxes, masks, class_ids, scores, class_names, filter_classs_names=None,
    ...
    N = boxes.shape[0]
    # If image contains no detection Use PIL to create blank image
    if not N:
        #print("\n*** No instances in image %s to draw *** \n" % (image_name))
        image_shape1 = image.shape[0] # take image shape of input Width
        image_shape2 = image.shape[1] # take image shape of input height
        masked_image = Image.new('L',(image_shape1,image_shape2))
        # print("\n*** No instances in image %s to draw *** \n" % (image_name))
